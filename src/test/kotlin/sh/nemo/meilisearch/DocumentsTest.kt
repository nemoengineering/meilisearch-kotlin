...
internal class DocumentsTest : BaseTest() {
    ...
    @Test
    fun `it can add a set of documents`() =
        runTest {
            // given
            val taskA = client.createIndex("index-1", "id")
            client.waitForTask(taskA.taskUid)
    ...
    @Test
    fun `it can upsert a set of documents`() =
        runTest {
            // given
            val taskA = client.createIndex("index-1", "id")
            client.waitForTask(taskA.taskUid)
    ...
    @Test
    fun `it can get a specific document`() =
        runTest {
            // given
            val taskA = client.createIndex("index-1", "id")
            client.waitForTask(taskA.taskUid)
    ...
    @Test
    fun `it can get delete all documents`() =
        runTest {
            // given
            val taskA = client.createIndex("index-1", "id")
            client.waitForTask(taskA.taskUid)
    ...
    @Test
    fun `it can get delete a specific document`() =
        runTest {
            // given
            val taskA = client.createIndex("index-1", "id")
            client.waitForTask(taskA.taskUid)
