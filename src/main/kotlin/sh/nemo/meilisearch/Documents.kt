...
suspend inline fun <reified T> Meilisearch.getDocument(
    indexUid: String,
    documentId: String,
): T = this.client.get("/indexes/$indexUid/documents/$documentId").body()

suspend fun Meilisearch.deleteAllDocuments(indexUid: String): ChangeResponse = this.client.delete("/indexes/$indexUid/documents").body()

suspend fun Meilisearch.deleteDocument(
    indexUid: String,
    documentId: String,
): ChangeResponse = this.client.delete("/indexes/$indexUid/documents/$documentId").body()
